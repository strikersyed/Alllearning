...
public class Tomorrow extends Section {
    /**
    ...
    public Tomorrow(ArrayList<Tasks> tasks, Context context,OnItemClick onitemclick,OnItemClick onstartclick,OnItemClick oncompleteclick) {
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
        ...
        if (tasks.size()>0) {
            viewHolder.todayheaderview.setText("Tomorrow");
